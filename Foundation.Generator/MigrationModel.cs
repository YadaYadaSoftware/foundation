...
public class MigrationModel : IMigrationModel
{
    ...
    public MigrationModel(string migrationId, TypeModel dataMigrationFunction, string migrationMethod, string dependsOn, string migrationAssembly, string migrationsAssemblyPath)
    {
