...
public class MigrationModelBuilder
{
    public static IMigrationModel Build(AttributeData migrationAttributeData, IMigrationFunctionAttributeModel migrationFunctionModel)
    {
        ...
        return new MigrationModel(migrationId, migrationFunctionModel.MigrationFunction, migrationFunctionModel.MigrationMethod, migrationFunctionModel.DependsOn, migrationFunctionModel.MigrationsAssemblyPath, migrationFunctionModel.MigrationsFunctionArn);
    }
}